---
title: "Design"
subtitle: "What wildfire is, what it targets, and what it refuses to be."
...
[Prior art](#baselines) is a capable general engine that gives up throughput to generality:
...
cache. Wildfire trades away generality to recover both. [Doctrine](#doctrine)
states the position; [prior art](#baselines) states the bar.
