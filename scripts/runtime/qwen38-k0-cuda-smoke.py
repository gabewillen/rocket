...
def run(
    ...
    return {
        ...
        "qsa_indexer": {
            ...
            "select_expand_control_ms": qsa_timing[
                "select_expand_control_ms"
            ],
            "select_expand_speedup_vs_control": (
                qsa_timing["select_expand_control_ms"]
                / qsa_timing["select_expand_ms"]
            ),
