...
export ROCKET_ROSA_MEMORY_GATE=${ROCKET_ROSA_MEMORY_GATE:-0}
export ROCKET_ROSA_MEMORY_LAYER=${ROCKET_ROSA_MEMORY_LAYER:--1}
export ROCKET_ROSA_TRACE=${ROCKET_ROSA_TRACE:-}
export ROCKET_ROSA_GATE_BIAS=${ROCKET_ROSA_GATE_BIAS:-}
export ROCKET_ROSA_GATE_CONF_W=${ROCKET_ROSA_GATE_CONF_W:-}
export ROCKET_ROSA_GATE_RECENCY_W=${ROCKET_ROSA_GATE_RECENCY_W:-}
export ROCKET_ROSA_GATE_NGRAM_W=${ROCKET_ROSA_GATE_NGRAM_W:-}
export ROCKET_ROSA_CORRUPT=${ROCKET_ROSA_CORRUPT:-}
...
remote=(env)
for v in ROCKET_FUEL_NVFP4_DIR ROCKET_PACKED_WEIGHTS ROCKET_EXPERT_SLAB_DIR ROCKET_RESIDENT_DIRECT ROCKET_RDMA_WAIT_S ROCKET_KDA_CUBLAS ROCKET_CUBLAS_ALL ROCKET_DFLASH2_DIR ROCKET_FP8_ATTN_DIR ROCKET_KDA_QKV_FP8_DIR ROCKET_FP8_CUBLAS ROCKET_MLA_LEGACY_CONTEXT ROCKET_MLA_LEGACY_SPLIT ROCKET_PROMPT_LOOKUP ROCKET_ROSA_MEMORY_GATE ROCKET_ROSA_MEMORY_LAYER ROCKET_ROSA_TRACE ROCKET_ROSA_GATE_BIAS ROCKET_ROSA_GATE_CONF_W ROCKET_ROSA_GATE_RECENCY_W ROCKET_ROSA_GATE_NGRAM_W ROCKET_ROSA_CORRUPT GLM53_ALLOW_LAUNCH; do
  [[ -n ${!v:-} ]] && remote+=("$v=${!v}")
done
